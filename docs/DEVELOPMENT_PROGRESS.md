...
**Ветка разработки:** `claude/add-subscription-tiers-7jPuM`
...
| Актуальные области | ✅ | Обновлены на 2022 (Улытауская и др.) |
...
├── hooks/
│   └── use-api.ts               # React Query hooks (включая admin)
├── lib/
│   ├── api.ts                   # API функции (включая admin)
│   └── utils.ts
├── pages/
│   ├── admin/                   # 10 страниц админки
│   │   ├── AdminLayout.tsx
│   │   ├── Dashboard.tsx        # → useAdminStats()
│   │   ├── UsersPage.tsx        # → useAdminUsers()
│   │   ├── BusinessesPage.tsx   # → useAdminBusinesses()
│   │   ├── EventsPage.tsx       # → useAdminEvents()
│   │   ├── PromotionsPage.tsx   # → useAdminPromotions()
│   │   ├── CitiesPage.tsx
│   │   ├── FinancePage.tsx
│   │   ├── ModerationPage.tsx
│   │   ├── AnalyticsPage.tsx
│   │   └── SettingsPage.tsx
│   ├── business/                # 4 страницы кабинета
│   │   ├── BusinessLayout.tsx   # Sidebar с лимитами тарифа
│   │   ├── Dashboard.tsx
│   │   ├── Publications.tsx
│   │   ├── Subscription.tsx
│   │   └── Banner.tsx
...
### Актуальные области Казахстана (обновлено 2022)

| Область | Города |
|---------|--------|
| Улытауская | Жезказган, Сатпаев, Каражал |
| Абайская | Семей |
| Жетысуская | Талдыкорган |
| Алматинская | Конаев |
| ... | (все 17 областей + 3 города респ. значения) |
...
| Тариф | Цена | Публикаций | Баннер |
|-------|------|------------|--------|
| Free | 0 ₸ | 3/мес | - |
| Lite | 50,000 ₸/мес | 10/мес | - |
| Premium | 200,000 ₸/мес | Безлимит | Да |
...
- [ ] Создание событий/акций из кабинета бизнеса
